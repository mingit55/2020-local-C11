        ...
        <input type="radio" name="slide" id="slide-5" hidden>
        <input type="radio" name="slide" id="slide-6" hidden>
        <input type="radio" name="slide" id="slide-1-copy" hidden>
        <input type="radio" name="slide" id="slide-2-copy" hidden>
        <input type="radio" name="slide" id="slide-3-copy" hidden>
        <input type="radio" name="slide" id="slide-4-copy" hidden>
        <input type="radio" name="slide" id="slide-5-copy" hidden>
        <input type="radio" name="slide" id="slide-6-copy" hidden>
        <div id="visual">
            <div class="d-none d-lg-block design-line"></div>
            <div class="d-none d-lg-block design-line"></div>
            <div class="images">
            ...
            <div class="position-center">
                <div class="segoe text-right text-gold fx-5">for Customer</div>
                <div class="segoe fx-8 text-white font-weight-bolder mt-n4">INTERIOR</div>
                <div class="text-gray fx-n2">나만의 인테리어로 새로운 공간을 만드세요</div>
            </div>
            <div class="buttons">
                <div class="s-btn mr-2">
    ...
    <div class="mt-4 mb-5 bg-darkblue position-relative">
        <div class="d-none d-lg-block design-text">EXPERTS</div>
        <div class="container">
            <div class="row">
                <div class="expert-item col-lg-3 col-6 mb-4 mb-lg-0">
                    <div class="inner">
                        <div class="front">
                            <img src="./resources/images/experts/specialist1.jpg" alt="전문가 이미지" title="전문가 이미지" class="fit-cover">
                        </div>
                        <div class="back py-5 d-flex flex-column-reverse bg-white">
                            <div class="d-flex align-items-center flex-column">
                                <span class="fx-2">전문가1</span>
                                <small class="text-gold">(specialist1)</small>
                                <hr style="width: 50px;">
                                <button class="px-4 py-2 text-white bg-blue">자세히 보기</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="expert-item col-lg-3 col-6 mb-4 mb-lg-0">
                    <div class="inner">
                        <div class="front">
                            <img src="./resources/images/experts/specialist2.jpg" alt="전문가 이미지" title="전문가 이미지" class="fit-cover">
                        </div>
                        <div class="back py-5 d-flex flex-column-reverse bg-white">
                            <div class="d-flex align-items-center flex-column">
                                <span class="fx-2">전문가2</span>
                                <small class="text-gold">(specialist2)</small>
                                <hr style="width: 50px;">
                                <button class="px-4 py-2 text-white bg-blue">자세히 보기</button>
                            </div>
                        </div>
                ...
                <div class="expert-item col-lg-3 col-6">
                    <div class="inner">
                        <div class="front">
                            <img src="./resources/images/experts/specialist3.jpg" alt="전문가 이미지" title="전문가 이미지" class="fit-cover">
                        </div>
                        <div class="back py-5 d-flex flex-column-reverse bg-white">
                            <div class="d-flex align-items-center flex-column">
                                <span class="fx-2">전문가3</span>
                                <small class="text-gold">(specialist3)</small>
                                <hr style="width: 50px;">
                                <button class="px-4 py-2 text-white bg-blue">자세히 보기</button>
                            </div>
                        </div>
                ...
                <div class="expert-item col-lg-3 col-6">
                    <div class="inner">
                        <div class="front">
                            <img src="./resources/images/experts/specialist4.jpg" alt="전문가 이미지" title="전문가 이미지" class="fit-cover">
                        </div>
                        <div class="back py-5 d-flex flex-column-reverse bg-white">
                            <div class="d-flex align-items-center flex-column">
                                <span class="fx-2">전문가4</span>
                                <small class="text-gold">(specialist4)</small>
                                <hr style="width: 50px;">
                                <button class="px-4 py-2 text-white bg-blue">자세히 보기</button>
                            </div>
                        </div>
    ...
    <div class="text-center pt-5">
        <button class="px-5 py-3 text-white bg-gold">
            더 보기
            <i class="fa fa-angle-right ml-3"></i>
        </button>
    </div>
    ...
    <div class="container padding">
        ...
        <div class="row">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="review-item p-lg-3 border">
                    <div class="image">
                        <img src="./resources/images/experts/specialist2.jpg" alt="전문가 이미지" title="전문가 이미지" class="fit-cover">
                    </div>
                    <div class="text px-4 py-3">
                        <div>
                            <span class="fx-2">전문가2</span>
                            <small class="text-muted">(specialist2)</small>
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-4 fx-n2 text-ellipsis text-muted">
                            원하던 아이언맨 컨셉으로 너무 잘 꾸며주셨습니다!
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mb-5 mb-lg-0">
                <div class="review-item p-lg-3 border">
                    ...
                    <div class="text px-4 py-3">
                        ...
                        <div class="mt-4 text-ellipsis text-muted fx-n2">
                            요구사항대로 부드러운 느낌을 잘 살려주셨습니다.
                        </div>
                    </div>
                </div>
            </div>
